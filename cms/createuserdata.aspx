<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createuserdata.aspx.cs" Inherits="cms.createuserdata" %>
...
<body>
    ...
    Created User Data
          ...
          <div class="table-container">
              <asp:GridView ID="GridView2" runat="server" CssClass="custom-gridview" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" DataKeyNames="userid" >
  
        <Columns>
            <asp:BoundField DataField="userid" HeaderText="User ID" ItemStyle-CssClass="gridview-cell" />
            <asp:BoundField DataField="role" HeaderText="Role" ItemStyle-CssClass="gridview-cell" />
            <asp:BoundField DataField="email" HeaderText="Email ID" ItemStyle-CssClass="gridview-cell" />
            <asp:BoundField DataField="password" HeaderText="Password" ItemStyle-CssClass="gridview-cell" />
            ...
            <asp:TemplateField HeaderText="Delete">
              <ItemTemplate>
    <asp:ImageButton ID="imgBtnDelete" runat="server" ImageUrl="\assets\bin.png" CommandName="DeleteRow" CommandArgument='<%# Eval("userid") %>' CssClass="action-button delete-button" OnClientClick="return confirmDelete();" />
</ItemTemplate>
