...
namespace cms
{
    public partial class updatesitemaster : System.Web.UI.Page
    {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    if (rowsAffected > 0)
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, GetType(), "UpdateSuccess", "showAlert(); window.location.href = 'showsitemasterdata.aspx';", true);
                    }
                    else
                    {
                        // Update failed
        ...
        protected void btncancel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/showsitemasterdata.aspx");
        }
