<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Createnewuser.aspx.cs" Inherits="cms.Createnewuser" %>
...
<body>
    ...
    <strong>Success!</strong> "Created  new User Successfuly".
</div>
        <div>
           <header class="font">
           <div>
...
<asp:RegularExpressionValidator ID="regexEmail" runat="server" 
    ...
    ForeColor="Red" Display="Dynamic" />
                                ...
                                <label class="block mt-4  text-xl">
                                    ...
                                    <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="block w-full mt-1 text-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" TextMode="Password" Placeholder="***************" />
    ...
    ForeColor="Red" Display="Dynamic" />
                      ...
                      <asp:Button ID="btnCreateAccount" runat="server" OnClick="create" Text="Create account"  CssClass="block w-full px-4 py-2 mt-4  text-xl font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" />
