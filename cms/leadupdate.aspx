<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leadupdate.aspx.cs" Inherits="cms.leadupdate" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Update Lead Master</title>
                ...
                <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    <div class="flex flex-col overflow-y-auto md:flex-row">
                        ...
                        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                            <div class="w-full">
                                <h1 class="mb-4 text-x1 text-teal-500 font-semibold text-gray-700 dark:text-gray-200">Update Register Lead</h1>
                                <label class="block text-lg custom-label">
    <span class="text-gray-700  ark:text-gray-400">Lead id</span>

                                    <asp:TextBox ID="txid" ReadOnly="true" runat="server" CssClass="block w-full mt-1 text-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" Placeholder="Parth" />
