...
namespace cms
{
    public partial class leadupdate : System.Web.UI.Page
    {
            ...
            // Check if the password and confirm password match
                ...
                try
                {
                        ...
                        if (rowsAffected > 0)
                        {
                            ...
                            ScriptManager.RegisterStartupScript(this, GetType(), "UpdateSuccess", "showAlert(); window.location.href = 'Leaddatashow.aspx';", true);
                        }
                        else
                        {
                            // Update failed
        ...
        protected void btncancel_Click(object sender, EventArgs e)
        {
            ...
            // Redirect to the logout page or any other page
            Response.Redirect("~/leaddatashow.aspx");
        }
    }
}