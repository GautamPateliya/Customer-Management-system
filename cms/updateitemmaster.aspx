<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateitemmaster.aspx.cs" Inherits="cms.updateitemmaster" %>
                        ...
                        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                            <div class="w-full">
                                ...
                                <label class="block mt-4  text-xl">
                                    ...
                                    <asp:TextBox ID="Txid" runat="server" ReadOnly="true" CssClass="block w-full mt-1 text-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"  Placeholder="" />
...
<asp:HiddenField ID="txkwHidden" runat="server" />
 ...
 <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"
    ...
    ValidationExpression="^\d+(\.\d+)?$"  ForeColor="Red" Display="Dynamic"/>
                      ...
                      <asp:Button ID="btnCreateAccount" runat="server" OnClick="create" Text="Update Item "  CssClass="block w-full px-4 py-2 mt-4  text-xl font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" />
